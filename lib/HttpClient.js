...
class HttpClient extends EventEmitter {
  ...
  #updateTransport () {
    ...
    this.__options.agent = new this._http.Agent(agentOptions)
  }
        ...
        response
          ...
          .on('end', async () => {
            ...
            if (
              ...
              this.__params.hostname = redirectUrl.hostname
              this.__params.port = redirectUrl.port
              ...
              let redirectResource = redirectUrl.pathname + redirectUrl.search
              const { path } = this.__params
              if (path && redirectResource.startsWith(path)) {
                redirectResource = redirectResource.slice(path.length) || '/'
              }
              ...
              this.emit(requestId, redirectResponse)
              return
            }
